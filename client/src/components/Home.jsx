...
export default function Home() {
  ...
  >
    <div
      ...
      className="relative left-[calc(50%-11rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#FFB703] to-[#E63946] opacity-40 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
    />
  </div>
